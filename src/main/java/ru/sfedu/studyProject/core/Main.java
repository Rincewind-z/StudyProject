package ru.sfedu.studyProject.core;

import org.apache.logging.log4j.LogManager;
import org.apache.logging.log4j.Logger;
import ru.sfedu.studyProject.core.DataProviders.DataProvider;
...
public class Main {
  ...
  private static void createProjects(DataProvider dataProvider) {
    ...
    dataProvider.createFursuitPart(0, 1, "Head", 18000);
    dataProvider.createFursuitPart(0, 1, "Paws", 3500);
    dataProvider.createFursuitPart(0, 1, "Tail", 3500);
