...
class   HibernateDataProviderTest {
    ...
    void createProjectTest() {
        ...
        projectList.forEach(project -> {
            dataProvider.createProject(project);
            log.debug(project);
    ...
    void createUrlTest() {
        ...
        customerList.forEach(customer -> {dataProvider.createCustomer(customer);
            ...
            URLs urLs = new URLs();
            urLs.setUrl("URL");
            urLs.setCustomer(customer);
            dataProvider.createUrl(urLs);
            Assertions.assertTrue(urLs.getId() != 0);
        });
    }
    ...
    void getUrlTest() {
        ...
        customerList.forEach(customer -> {dataProvider.createCustomer(customer);
            ...
            dataProvider.createUrl(urLs);
            Assertions.assertTrue(urLs.getId() != 0);
            Optional<URLs> optionalURLs = dataProvider.getUrl(urLs.getId());
            Assertions.assertTrue(optionalURLs.isPresent());
            Assertions.assertEquals(urLs, optionalURLs.get());
        });
    }
    ...
    void updateUrlTest() {
        ...
        customerList.forEach(customer -> {dataProvider.createCustomer(customer);
            ...
            dataProvider.createUrl(urLs);
            Assertions.assertTrue(urLs.getId() != 0);
            urLs.setUrl("Edited URL");
            dataProvider.editUrl(urLs);
            Optional<URLs> optionalURLs = dataProvider.getUrl(urLs.getId());
            Assertions.assertTrue(optionalURLs.isPresent());
            Assertions.assertEquals(urLs, optionalURLs.get());
        });
    ...
    void deleteUrlTest() {
        ...
        customerList.forEach(customer -> {dataProvider.createCustomer(customer);
            ...
            Optional<URLs> optionalURLs = dataProvider.getUrl(urLs.getId());
            Assertions.assertTrue(optionalURLs.isPresent());
            dataProvider.deleteUrl(urLs);
            Assertions.assertTrue(dataProvider.getUrl(urLs.getId()).isEmpty());
        });
    }
}